...
class Verify
{
    protected $config = [
        // 验证码加密密钥
        'seKey'    => 'QWERTYUIOP15935724862684',
        // 验证码字符集合
        'codeSet'  => '0123456789qwertyuiopasdfghjklxcvbnmQWERTYUIOPSDFGHJKLZXCVBNM',
        // 验证码过期时间（s）
        'expire'   => 600,
        // 使用中文验证码
        'useZh'    => false,
    ...
    public function entry($id = '')
    {
        ...
        Cache::set($key . $id, json_encode($secode), $this->expire);
